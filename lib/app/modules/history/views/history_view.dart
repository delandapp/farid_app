...
import 'package:e_perpustakaan/app/data/models/response_history_peminjaman.dart';
import 'package:e_perpustakaan/app/modules/history/controllers/history_controller.dart';
                    ...
                    style: TextStyle(
                        fontFamily:
                            GoogleFonts.poppins(fontWeight: FontWeight.w400)
                                .fontFamily,
                        fontSize: 20,color: const Color(0xFFDDDDDD)),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.justify,
                  ),
